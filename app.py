...
<body>
    ...
    <div id="messages-container" class="messages-area">
      <div id="hero-welcome" class="hero-box">
        ...
        <div class="hero-grid">
          ...
          <button type="button" onclick="sendQuickPrompt('What is math?')" class="hero-card">
            <span>📐 Fundamentals of Mathematics</span>
          </button>
        </div>
      </div>
  ...
  <script>
    ...
    async function submitPrompt() {
      ...
      userDiv.className = 'chat-bubble-user';
      userDiv.innerHTML = `
        <div class="content">${displayUserHtml}</div>
        <div class="avatar avatar-user">U</div>`;
      container.appendChild(userDiv);

      // 2. Assistant Loading Bubble
